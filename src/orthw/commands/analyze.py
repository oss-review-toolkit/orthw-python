...
def analyze(
    ...
    if not docker:
        if settings.ort_config_package_curations_dir.exists():
            ...
            logger.warning("No curations folder available. Running without curations.")
...
@command_group.command(
    ...
    short_help="Runs ORT Analyzer on given source code directory to find used dependencies.",
)
