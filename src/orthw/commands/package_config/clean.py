...
@package_config_group.command(
    ...
    name="clean",
    help="""
        Removes all path excludes and license finding curations from the package configuration file
        for given package id which do not match any files or license findings.
    """,
